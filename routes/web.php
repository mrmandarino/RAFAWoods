...
Route::middleware(['auth'])->group(function(){
    ...
    Route::get('/admin/visualizar/{tabla}/editar_fila/{key}',[AdminController::class, 'edit'])->name('admin_editar_fila');
    Route::put('/admin/visualizar/{tabla}/editar_fila/{key}',[AdminController::class, 'update'])->name('admin_update_fila');
