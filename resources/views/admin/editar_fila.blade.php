        ...
        <div class="col-6 card p-3 bg-light mt-3">
            ...
            <div class="div">
                ...
                <form action={{route('admin_update_fila',['key' => $key,'tabla' => $tabla, 'key2' => $key2])}} method="POST">
                    ...
                    <button type="submit" class="btn btn-primary row justify-content-center text-center mt-3 col-5" style="margin-left: 110px " tabindex="21" onclick="return confirm('¿Está usted seguro de querer guardar los cambios?')">Guardar</button>
