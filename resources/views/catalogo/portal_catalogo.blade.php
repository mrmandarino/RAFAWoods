...
<main>
  ...
  <section class="py-5 text-center container">
    <form action="#">
      <div class="row py-lg-5">
        <input class="form-control" list="datalist_familia_productos" id="input_datalist_familia_productos" placeholder="Buscar...">
  ...
  <div class="album py-5 bg-light" onload="carga_datos()">
    <div class="container">
        ...
        <br>
        {{-- Paginador --}}
        <nav aria-label="..." onload="creacion_paginador()">
...
<script type="text/javascript">
  <?php
  $js_array = json_encode($cantidad_productos);
